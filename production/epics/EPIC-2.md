...
- 验收标准：
  - [x] 敌人沿 waypoints 循环移动，恒速 2 tile/s
  - [x] 接触后 payload 四字段全部正确（return_position 在敌人反向外侧一格）
  - [x] 敌人间无碰撞、与玩家/地形有碰撞
...
- 验收标准：
  - [x] Router 切入战斗时转场黑屏正常，payload 非法则拒绝
  - [x] 战斗场景从 GameData 读队伍初始态（显示在占位 UI 上）
...
- 验收标准：
  - [x] 胜利：敌人节点移除，玩家回到敌人旁一格
  - [x] 失败：能回到地图（读档逻辑占位），GameData 数据正确覆写
  - [x] 战后回图立即再撞同一敌人不会秒进战斗（immunity 生效）

## M2 收口
> 收口门进度（主理人游承峰，Lean 口径，2026-08-30）：门1 GUT 62/62 PASS ✅ ｜ 门2 A8 行 2 四要素勾绿 ✅（见上各 Story 验收框）｜ 门3 试玩视频 #2 待录 ｜ 门4 未跟踪文件待裁决 ｜ 门5 tag m2 待打。
