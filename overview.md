...
| 当前 Sprint | Sprint 4 · EPIC-4「遗迹可探索 + 存档落地」进行中（S0~S3 ✅，剩余 S4~S7 ≈7h） |
| 待办尾巴 | 无——前段收口已 commit（2026-08-30 晚，用户拍板） |
| 测试基线 | GUT 9.7.1，**229/229 全绿**（`evidence/e4s3-gut-s3.log`；221 基线另证 `evidence/e4s2-gut-s2.log`） |
| 下一道门 | M4：三层遗迹可探索 + 存档落地——当前 **E4-S4 敌人三态完整 AI（1.5h）** |
...
| M4 遗迹可探索 + 存档落地 | EPIC-4（19h） | 进行中：S0~S3 ✅（D3 修复一并入库），剩 S4~S7 | commit db8a6be（S0~S2）+ 021ffb7（S3） |
| M5 ~ M7 | EPIC-5 ~ 7 | 待启动 | — |
